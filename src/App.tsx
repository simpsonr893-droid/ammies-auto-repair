...
export default function App() {
  return (
    <div className="min-h-screen bg-white font-sans text-slate-900">
      ...
      <nav className="fixed top-0 w-full bg-white/80 backdrop-blur-md z-40 border-b border-slate-100">
        <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-xl tracking-tight">Ammie's <span className="text-emerald-600">Auto Repair</span></span>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-lg text-slate-600 mb-8 max-w-lg leading-relaxed">
              From minor dents to major collision damage, Ammie's Auto Repair restores your vehicle to factory perfection. Fast, reliable, and insurance-approved.
            </p>
          ...
          >
            <div className="relative rounded-3xl overflow-hidden shadow-2xl border-8 border-white">
              <img
                ...
                alt="Autobody workshop with a car being repaired"
                width={1000}
                height={500}
              ...
              <div className="space-y-8">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="tel:7206765646" className="text-white/60 hover:text-white transition-colors">(720) 676-5646</a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:service@ammiesautorepair.com" className="text-white/60 hover:text-white transition-colors">service@ammiesautorepair.com</a>
                  </div>
                </div>
              </div>
            </div>
      ...
      {/* Footer */}
      <footer className="py-12 bg-slate-950 text-white/60 text-sm border-t border-white/5">
        <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="flex items-center gap-2 text-white">
            <Wrench size={20} className="text-emerald-500" />
            <span className="font-bold text-lg tracking-tight">Ammie's Auto Repair</span>
          </div>

          <div className="flex gap-8">
            <a href="mailto:service@ammiesautorepair.com" className="hover:text-white transition-colors">Privacy Policy</a>
            <a href="mailto:service@ammiesautorepair.com" className="hover:text-white transition-colors">Terms of Service</a>
            <a href="tel:7206765646" className="hover:text-white transition-colors">Accessibility</a>
          </div>

          <div className="flex gap-4">
            <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" aria-label="Visit us on Facebook" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-white/10 transition-colors text-white">
              <Facebook size={18} />
            </a>
            <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" aria-label="Visit us on Twitter" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-white/10 transition-colors text-white">
              <Twitter size={18} />
            </a>
            <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" aria-label="Visit us on Instagram" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-white/10 transition-colors text-white">
              <Instagram size={18} />
            </a>
          </div>
        </div>
        <div className="max-w-7xl mx-auto px-4 mt-8 text-center">
          <p>© {new Date().getFullYear()} Ammie's Auto Repair. All rights reserved.</p>
        </div>
      </footer>
